...
```
sudo apt-get install build-essential qtcreator libqt5svg5-dev \
  qtbase5-dev libgvc6 python git gitk \
  python-dev libgraphviz-dev libpopt-dev doxygen xsltproc cmake \
  libxaw7-dev libxv-dev libxt-dev zlib1g-dev
```
